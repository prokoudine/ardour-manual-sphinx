.. _default_keyboard_bindings:

Default keyboard bindings
=========================

Almost every available function in Ardour can be bound to a keyboard shortcut (and those few that cannot will usually respond to an :ref:`OSC command <open_sound_control>`). Ardour comes with a rich set of default **key bindings** for the most commonly used functions.
...
:kbd:`S` for :menuselection:`Region > Edit > Split` or :kbd:`P` for **Transport > Playhead > Playhead to Mouse**.
